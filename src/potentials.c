...
/*******************************************************************************************
 * Name       | ComputeDampingCoefficientsThirdDerivatives                                *
 * --------------------------------------------------------------------------------------- *
 * Function   | Returns the damping third derivatives for the Pellenq-potential           *
 * Parameters | REAL r: the Cartesian distance                                             *
 *            | REAL b: a parameter                                                        *
 * Returns    | REAL *f6:  the damping second derivative of the r^-6 term                  *
 *            | REAL *f8:  the damping second derivative of the r^-8 term                  *
...
void ComputeDampingCoefficientsThirdDerivatives(REAL r, REAL b,REAL *f6,REAL *f8,REAL *f10,REAL *f12)
{
  REAL val;
  REAL x,x4,x5,x6,x7,x8,x9,x10,x11,x12;
  ...
  *f6= (x4/24.0-      x5/60.0+       x6/720.0)*val;
  *f8= (x6/720.0-     x7/2520.0+     x8/40320.0)*val;
  *f10=(x8/40320.0-   x9/181440.0+   x10/3628800.0)*val;
  *f12=(x10/3628800.0-x11/19958400.0+x12/479001600.0)*val;
}
...
void PotentialThirdDerivative(int typeA,int typeB,REAL rr,REAL *energy,REAL *factor1,REAL *factor2,REAL *factor3)
{
  ...
  REAL ri6,ri9;
  REAL exp1,exp2,exp_term,P;
  REAL f6,f8,f10,f12,f6d,f8d,f10d,f12d,f6dd,f8dd,f10dd,f12dd,f6ddd,f8ddd,f10ddd,f12ddd;
  REAL rri2,rri4,rri5,rri6,rri8,rri10,rri12,rri14,rri16;
  REAL term1,term2;
  REAL SwitchingValue,SwitchingValueDerivative;
...
// Ambar/Hanjun edit
    ...
    case PELLENQ_NICHOLSON:
      ...
      ComputeDampingCoefficients(r,arg2,&f6,&f8,&f10,&f12);
      ComputeDampingCoefficientsDerivatives(r,arg2,&f6d,&f8d,&f10d,&f12d);
      ComputeDampingCoefficientsSecondDerivatives(r,arg2,&f6dd,&f8dd,&f10dd,&f12dd);
      ComputeDampingCoefficientsThirdDerivatives(r,arg2,&f6ddd,&f8ddd,&f10ddd,&f12ddd);
      /*
      Code below is generated by following Maple commands
        restart;
        with(CodeGeneration):
        # Define the potential energy
        f0 := arg1*exp(-arg2*r)-g_6(r)*arg3/r^6-g_8(r)*arg4/r^8-g_10(r)*arg5/r^(10)-g_12(r)*arg6/r^12-arg7;
        # Compute derivatives, each derivative gets a factor 1/r
        f1 := simplify((diff(f0, r))/r):
        f2 := simplify((diff(f1, r))/r):
        f3 := simplify((diff(f2, r))/r):
        # Subsitute damping functions and their derivatives to variables as defined above
        f0 := subs({diff(g_6(r), r) = f6d, diff(g_6(r), r, r) = f6dd, diff(g_6(r), r, r, r) = f6ddd, g_6(r) = f6}, f0):
        f1 := subs({diff(g_6(r), r) = f6d, diff(g_6(r), r, r) = f6dd, diff(g_6(r), r, r, r) = f6ddd, g_6(r) = f6}, f1):
        f2 := subs({diff(g_6(r), r) = f6d, diff(g_6(r), r, r) = f6dd, diff(g_6(r), r, r, r) = f6ddd, g_6(r) = f6}, f2):
        f3 := subs({diff(g_6(r), r) = f6d, diff(g_6(r), r, r) = f6dd, diff(g_6(r), r, r, r) = f6ddd, g_6(r) = f6}, f3):
        f0 := subs({diff(g_8(r), r) = f8d, diff(g_8(r), r, r) = f8dd, diff(g_8(r), r, r, r) = f8ddd, g_8(r) = f8}, f0):
        f1 := subs({diff(g_8(r), r) = f8d, diff(g_8(r), r, r) = f8dd, diff(g_8(r), r, r, r) = f8ddd, g_8(r) = f8}, f1):
        f2 := subs({diff(g_8(r), r) = f8d, diff(g_8(r), r, r) = f8dd, diff(g_8(r), r, r, r) = f8ddd, g_8(r) = f8}, f2):
        f3 := subs({diff(g_8(r), r) = f8d, diff(g_8(r), r, r) = f8dd, diff(g_8(r), r, r, r) = f8ddd, g_8(r) = f8}, f3):
        f0 := subs({diff(g_10(r), r) = f10d, diff(g_10(r), r, r) = f10dd, diff(g_10(r), r, r, r) = f10ddd, g_10(r) = f10}, f0):
        f1 := subs({diff(g_10(r), r) = f10d, diff(g_10(r), r, r) = f10dd, diff(g_10(r), r, r, r) = f10ddd, g_10(r) = f10}, f1):
        f2 := subs({diff(g_10(r), r) = f10d, diff(g_10(r), r, r) = f10dd, diff(g_10(r), r, r, r) = f10ddd, g_10(r) = f10}, f2):
        f3 := subs({diff(g_10(r), r) = f10d, diff(g_10(r), r, r) = f10dd, diff(g_10(r), r, r, r) = f10ddd, g_10(r) = f10}, f3):
        f0 := subs({diff(g_12(r), r) = f12d, diff(g_12(r), r, r) = f12dd, diff(g_12(r), r, r, r) = f12ddd, g_12(r) = f12}, f0):
        f1 := subs({diff(g_12(r), r) = f12d, diff(g_12(r), r, r) = f12dd, diff(g_12(r), r, r, r) = f12ddd, g_12(r) = f12}, f1):
        f2 := subs({diff(g_12(r), r) = f12d, diff(g_12(r), r, r) = f12dd, diff(g_12(r), r, r, r) = f12ddd, g_12(r) = f12}, f2):
        f3 := subs({diff(g_12(r), r) = f12d, diff(g_12(r), r, r) = f12dd, diff(g_12(r), r, r, r) = f12ddd, g_12(r) = f12}, f3):
        # Generate C code
        code := C([U = f0, fcVal1 = f1, fcVal2 = f2, fcVal3 = f3], optimize, defaulttype = float, deducetypes = true,output=string):
      */
      REAL t2, t4, t5, t6, t7, t10, t11, t14, t18, t23, t26, t28, t29, t30, t31, t34, t35, t38, t39, t42, t45, t48, t51, t53, t57, t61, t65, t68, t69, t99;
      t2 = exp(-arg2 * r);
      t4 = f6 * arg3;
      t5 = r * r;
      t6 = t5 * t5;
      ...
      t14 = f10 * arg5;
      t18 = f12 * arg6;
      U = arg1 * t2 - t4 / t7 - t10 / t11 - t14 / t11 / t5 - t18 / t11 / t6 - arg7;
      t23 = t6 * r;
      t26 = arg1 * arg2 * t2 * t11 * t23;
      t28 = t5 * r;
      t29 = t6 * t28;
      t30 = f6d * arg3 * t29;
      t31 = t4 * t7;
      ...
      t42 = f12d * arg6 * r;
      t45 = t11 * t7;
      fcVal1 = -(t26 + t30 - 0.6e1 * t31 + t34 - 0.8e1 * t35 + t38 - 0.10e2 * t39 + t42 - 0.12e2 * t18) / t45;
      t48 = arg2 * arg2;
      t51 = arg1 * t48 * t2 * t45;
      t53 = f6dd * arg3 * t11;
      t57 = f8dd * arg4 * t7;
      t61 = f10dd * arg5 * t6;
      t65 = f12dd * arg6 * t5;
      t68 = t51 + t26 - t53 + 0.13e2 * t30 - 0.48e2 * t31 - t57 + 0.17e2 * t34 - 0.80e2 * t35 - t61 + 0.21e2 * t38 - 0.120e3 * t39 - t65 + 0.25e2 * t42 - 0.168e3 * t18;
      t69 = t11 * t11;
      fcVal2 = t68 / t69;
      t99 = -0.21e2 * t53 + 0.165e3 * t30 - 0.480e3 * t31 - 0.27e2 * t57 + 0.267e3 * t34 - 0.960e3 * t35 - 0.33e2 * t61 + 0.393e3 * t38 - 0.1680e4 * t39 - 0.39e2 * t65 + 0.543e3 * t42 + f6ddd * arg3 * t11 * r + f8ddd * arg4 * t29 + f10ddd * arg5 * t23 + f12ddd * arg6 * t28 + 0.3e1 * t51 + 0.3e1 * t26 + arg1 * t48 * arg2 * t2 * t11 * t29 - 0.2688e4 * t18;
      fcVal3 = -t99 / t69 / t5;
/*      rri2=1.0/rr;*/
/*      rri4=rri2*rri2;*/
/*      rri6=rri4*rri2;*/
...
/*      fcVal3 = 0.0;*/
    ...
    case MEDFF:
      ...
      ComputeDampingCoefficients(r,arg12,&f6,&f8,&f10,&f12);
      ComputeDampingCoefficientsDerivatives(r,arg12,&f6d,&f8d,&f10d,&f12d);
      ComputeDampingCoefficientsSecondDerivatives(r,arg12,&f6dd,&f8dd,&f10dd,&f12dd);
      ComputeDampingCoefficientsThirdDerivatives(r,arg12,&f6ddd,&f8ddd,&f10ddd,&f12ddd);
      /*
      Code below is generated by following Maple commands
        restart;
        with(CodeGeneration);
        # Define the potential energy
        f0 := (arg1/r+arg2+arg3*r+arg4*r*r+(arg5*r*r)*r)*exp(-arg6*r)+(arg7/r+arg8)*exp(-arg9*r)-g_6(r)*arg10/r^6-g_8(r)*arg11/r^8-arg13;
        # Compute derivatives, each derivative gets a factor 1/r
        f1 := simplify((diff(f0, r))/r);
        f2 := simplify((diff(f1, r))/r);
        f3 := simplify((diff(f2, r))/r);
        ...
        f3 := subs({diff(g_8(r), r) = f8d, diff(g_8(r), r, r) = f8dd, diff(g_8(r), r, r, r) = f8ddd, g_8(r) = f8}, f3);
        # Generate C code
        C([U = f0, fcVal1 = f1, fcVal2 = f2, fcVal3 = f3], optimize, defaulttype = float, deducetypes = false);
      */
      REAL t1, t4, t6, t10, t15, t17, t18, t19, t22, t23, t26, t27, t29, t30, t31, t34, t35, t36, t37, t38, t39, t40, t42, t44, t46, t49, t51, t52, t53, t56, t58, t60, t61, t64, t66, t70, t73, t74, t75, t76, t78, t80, t84, t86, t87, t88, t89, t91, t93, t101, t103, t104, t118, t119, t131, t137, t152;
      t1 = 0.1e1 / r;
      t4 = r * r;
      t6 = t4 * r;
      t10 = exp(-arg6 * r);
      ...
      t22 = f8 * arg11;
      t23 = t18 * t18;
      U = (arg1 * t1 + arg3 * r + arg4 * t4 + arg5 * t6 + arg2) * t10 + (arg7 * t1 + arg8) * t15 - t17 / t19 - t22 / t23 - arg13;
      t26 = t10 * arg5;
      t27 = t23 * t6;
      t29 = 0.3e1 * t26 * t27;
      t30 = t10 * arg4;
      ...
      t44 = t30 * arg6 * t27;
      t46 = t34 * arg6 * t31;
      t49 = t10 * arg2 * arg6 * t35;
      t51 = t37 * arg6 * t23;
      t52 = arg7 * t15;
      t53 = t52 * t38;
      t56 = t15 * arg8 * arg9 * t35;
      t58 = t52 * arg9 * t23;
      t60 = f6d * arg10 * t6;
      t61 = t17 * t4;
      t64 = f8d * arg11 * r;
      t66 = -0.2e1 * t30 * t31 - 0.8e1 * t22 - t29 - t36 + t39 + t42 + t44 + t46 + t49 + t51 + t53 + t56 + t58 + t60 - 0.6e1 * t61 + t64;
      fcVal1 = -t66 / t31;
      t70 = 0.3e1 * t44;
      t73 = arg6 * arg6;
      t74 = t73 * t10;
      ...
      t84 = t74 * arg2 * t31;
      t86 = t74 * arg1 * t35;
      t87 = t74 * arg3 * t27 - 0.5e1 * t42 - t46 + t49 + 0.3e1 * t51 + t56 + 0.3e1 * t58 - t70 + t78 + t80 + t84 + t86;
      t88 = arg9 * arg9;
      t89 = t88 * t15;
      t91 = t89 * arg8 * t31;
      t93 = t89 * arg7 * t35;
      t101 = f6dd * arg10 * t18;
      t103 = f8dd * arg11 * t4;
      t104 = t91 + t93 - 0.80e2 * t22 + t29 - t36 + 0.3e1 * t39 + 0.3e1 * t53 + 0.13e2 * t60 - 0.48e2 * t61 + 0.17e2 * t64 - t101 - t103;
      fcVal2 = (t87 + t104) / t40;
      t118 = t73 * arg6 * t10;
      t119 = t23 * t19;
      t131 = t88 * arg9 * t15;
      t137 = t118 * arg1 * t31 + f6ddd * arg10 * t75 + f8ddd * arg11 * t6 + t118 * arg2 * t27 + t118 * arg3 * t40 + t118 * arg4 * t76 + t118 * arg5 * t119 + t131 * arg7 * t31 + t131 * arg8 * t27 + 0.3e1 * t42 - 0.6e1 * t78 - 0.3e1 * t80 + 0.3e1 * t84 + 0.6e1 * t86 + 0.3e1 * t91 + 0.6e1 * t93;
      t152 = -t70 - 0.3e1 * t46 + 0.3e1 * t49 + 0.15e2 * t51 + 0.3e1 * t56 + 0.15e2 * t58 + t29 - 0.3e1 * t36 + 0.15e2 * t39 + 0.15e2 * t53 + 0.165e3 * t60 - 0.480e3 * t61 + 0.267e3 * t64 - 0.21e2 * t101 - 0.27e2 * t103 - 0.960e3 * t22;
      fcVal3 = -(t137 + t152) / t119;
/*      rri2=1.0/rr;*/
/*      rri4=rri2*rri2;*/
/*      rri6=rri4*rri2;*/
/*      rri8=rri6*rri2;*/
...
/*      fcVal3 = 0.0;*/
    ...
    case MM3_HYDROGEN_VDW:
      ...
      if(P>3.02)
      {
        term1=arg1*192.270*SQR(P);
        U=term1-arg3;
        fcVal1=-2.0*term1/rr;
        fcVal2=8.0*term1/(rr*rr);
        fcVal3=-48.0*term1/(rr*rr*rr);
      }
      else
      {
        rri3=arg1*2.25*CUBE(SQR(P));
        ...
        U=exp_term-rri3-arg3;
        fcVal1=-(12.0*exp_term/(arg2*r)-(6.0/rr)*rri3);
        fcVal2= (12.0/(arg2*r)+1.0/rr)*exp_term*12.0/(arg2*r) - 48.0/(rr*rr)*rri3;
        fcVal3= -(144.0/(arg2*arg2*r*r)+36.0/(arg2*r*rr)+3.0/(rr*rr))*exp_term*12.0/(arg2*r) + 480.0/(rr*rr*rr)*rri3;
      }
      break;
    default:
      U=0.0;
